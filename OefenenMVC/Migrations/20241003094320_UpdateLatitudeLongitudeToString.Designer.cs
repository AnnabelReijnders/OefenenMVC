...
namespace OefenenMVC.Migrations
{
    ...
    [Migration("20241003094320_UpdateLatitudeLongitudeToString")]
    partial class UpdateLatitudeLongitudeToString
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OefenenMVC.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventID = 1,
                            Cost = 10.00m,
                            Date = new DateTime(2024, 10, 3, 11, 43, 19, 520, DateTimeKind.Local).AddTicks(3858),
