...
namespace OefenenMVC.Migrations
{
    ...
    [Migration("20240927213003_AddLatitudeLongitudeToEvent")]
    partial class AddLatitudeLongitudeToEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OefenenMVC.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventID = 1,
                            Cost = 10.00m,
                            Date = new DateTime(2024, 9, 27, 23, 30, 3, 271, DateTimeKind.Local).AddTicks(7780),
