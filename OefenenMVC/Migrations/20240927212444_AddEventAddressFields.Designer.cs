...
namespace OefenenMVC.Migrations
{
    ...
    [Migration("20240927212444_AddEventAddressFields")]
    partial class AddEventAddressFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OefenenMVC.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventID = 1,
                            Cost = 10.00m,
                            Date = new DateTime(2024, 9, 27, 23, 24, 43, 710, DateTimeKind.Local).AddTicks(5815),
