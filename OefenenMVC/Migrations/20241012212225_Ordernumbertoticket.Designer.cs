...
namespace OefenenMVC.Migrations
{
    ...
    [Migration("20241012212225_Ordernumbertoticket")]
    partial class Ordernumbertoticket
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OefenenMVC.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventID = 1,
                            Cost = 10.00m,
                            Date = new DateTime(2024, 10, 12, 23, 22, 25, 36, DateTimeKind.Local).AddTicks(2309),
